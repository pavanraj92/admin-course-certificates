...
{
    protected $signature = 'certificates:test-views';
    protected $description = 'Test view resolution for Certificates module';

    public function handle()
    {
        $this->info('🔍 Testing View Resolution for Certificates Module...');
        ...
        foreach ($testViews as $viewName) {
            ...
            $namespaces = [
                'certificates-module::' . $viewName => 'Module View',
                'certificate::' . $viewName => 'Package View',
            ];
        ...
        $controller = new \Modules\Certificates\app\Http\Controllers\Admin\CertificateController();
        ...
        $this->info("\n📋 View Loading Order:");
        $this->info("1. certificates-module:: (Module views - highest priority)");
        $this->info("2. certificate:: (Package views - fallback)");

        $this->info("\n💡 Tips:");
        $this->info("- Edit views in Modules/Certificates/resources/views/ to use module views");
